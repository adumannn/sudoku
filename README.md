...
| **For**          | solvers who'd rather *do* a puzzle than be marketed to about one                                 |
...
| **Для кого**     | тех, кто хочет *решать* задачу, а не быть аудиторией маркетинга                            |
...
2. [Продуктовая поверхность](#продуктовая-поверхность)
3. [Инженерные акценты](#инженерные-акценты)
4. [Поверх ТЗ](#поверх-тз)
5. [Стек](#стек)
6. [Запуск](#запуск)
7. [Карта проекта](#карта-проекта)
8. [Планка качества](#планка-качества)
9. [Дальше](#дальше)
